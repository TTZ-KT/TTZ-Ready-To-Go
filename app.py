...
import os
from rag_engine_enhanced import RAGEngine
import time
...
st.markdown("### *Files Assistant + General Chat - Ollama Powered*")
...
with st.sidebar:
    ...
    model_info = {
        ...
        "llama3.2-vision": "🖼️ Vision AI - Understands images",
        "llava": "🖼️ Vision AI - Fast image processing",
        "bakllava": "🖼️ Vision AI - Alternative vision model",
            ...
            with st.spinner("Processing documents..."):
                try:
                    ...
                    if st.session_state.document_processed:
                        existing_docs = st.session_state.rag_engine.vectorstore
...
with col3:
    st.caption("v8.1 VISION - 24 Models + Image Support 🖼️")